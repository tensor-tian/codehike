...
To set up Code Hike you need to [import the <CH.InlineCode>@code-hike-local/mdx</CH.InlineCode> plugin](focus://1,6[1:6]), and add it to the remarkPlugins array in the next.config.js file.
...
const { remarkCH } = require("@code-hike-local/mdx")
